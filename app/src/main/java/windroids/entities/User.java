...
public class User implements Serializable {
	...
	public User(String userName, String password, String profileImage, String fullName, String email, Date birthDate,
			String city,
			Boolean isDoctor, String doctorType, Boolean isCoach, String coachType,
			HashMap<Data.Type, ArrayList<Data>> datas, ArrayList<String> connections) {
