...
public enum BluetoothUUID {
    ...
    BloodPressureMeasurementCharacteristic("Blood Pressure Measurement", 0x2A35, STANDARD),
    ...
    RunningSpeedAndCadenceMeasurementCharacteristic("Running Speed and Cadence Measurement", 0x2A53, STANDARD),
